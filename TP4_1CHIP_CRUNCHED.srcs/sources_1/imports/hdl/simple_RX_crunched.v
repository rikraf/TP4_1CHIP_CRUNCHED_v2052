...
gty_block  #(.TOP(TOP))aurora_64b66b_0_multi_gt_i
 (
         ...
         .gtwiz_reset_tx_pll_and_datapath_in       (1'b0),//(1'b0),
...
descrambler_tpx4 DESCRAM
 ...
 cdc_sync
   ...
   generate
      if (COMPILE_FOR_SIM == 1) begin: FOR_SIM
         reg gty_header_valid_d4;
         reg gty_header_valid_d5;
         reg gty_data_valid_d4;
         reg gty_data_valid_d5;
         reg [1:0] gty_header_d4;
         reg [1:0] gty_header_d5;
        always @(posedge rxusrclk_out) begin
            gty_header_valid_d4 <= gty_header_valid_d3;
            gty_header_valid_d5 <= gty_header_valid_d4;
            gty_data_valid_d4 <= gty_data_valid_d3;
            gty_data_valid_d5 <= gty_data_valid_d4;
            gty_header_d4 <= gty_header_d3;
            gty_header_d5 <= gty_header_d4;
        end
        assign rx_header_valid = gty_header_valid_d5;
        assign rx_header_out = gty_header_d5;
        assign rx_data_valid = pass_control_chars_sync ? gty_data_valid_d5 : (gty_data_valid_d5 && (gty_header_d5 == 2'b10));
     end 
      else begin: NO_SIM
