...
architecture STRUCTURE of design_1_clk_wiz_1_0_design_1_clk_wiz_1_0_clk_wiz is
  signal clk_100_design_1_clk_wiz_1_0 : STD_LOGIC;
  signal clk_200_design_1_clk_wiz_1_0 : STD_LOGIC;
  signal clk_20_design_1_clk_wiz_1_0 : STD_LOGIC;
  signal clk_40_design_1_clk_wiz_1_0 : STD_LOGIC;
  signal clk_in1_design_1_clk_wiz_1_0 : STD_LOGIC;
  signal clk_in1_design_1_clk_wiz_1_0_buf : STD_LOGIC;
...
clkin1_bufg1: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_in1_design_1_clk_wiz_1_0_buf,
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_design_1_clk_wiz_1_0_buf
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_100_design_1_clk_wiz_1_0,
      O => clk_100
    );
...
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_200_design_1_clk_wiz_1_0,
      O => clk_200
    );
