...
design_libs=(xilinx_vip xpm xbip_utils_v3_0_15 axi_utils_v2_0_11 xbip_pipe_v3_0_11 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_24 floating_point_v7_0_26 div_gen_v5_1_25 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  vhdlan -work floating_point_v7_0_26 $vhdlan_opts \
  "../../../ipstatic/hdl/floating_point_v7_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work div_gen_v5_1_25 $vhdlan_opts \
