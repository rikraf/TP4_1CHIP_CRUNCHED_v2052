...
# set xvlog options
xvlog_opts="--incr --relax  -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L cmac_usplus_v3_1_24 -L xilinx_vip"
...
simulate()
{
  xsim div_gen_0 -key {Behavioral:sim_1:Functional:div_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4194.protoinst" -protoinst "protoinst_files/bd_929b.protoinst" -log simulate.log
}
