...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L cmac_usplus_v3_1_24 -L xilinx_vip"
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4194.protoinst" -protoinst "protoinst_files/bd_929b.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
